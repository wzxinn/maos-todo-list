  ...
  computed: {
    riskGroups() {
            ...
            var DEF = [
              ...
              { key: 'debt', title: '迭代欠账', color: '#f56c6c', desc: '已结束迭代还有没做完的任务', match: function(r){ return r.kind === 'debt'; } },
              { key: 'milestone', title: '里程碑漂移', color: '#0284c7', desc: '转测节点/发布窗口临近而未达成', match: function(r){ return r.kind === 'milestone_shift'; } }
            ];
